			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="sub-menu"><a class="active" href="./myBlogAll.do">
							...
							<li class="active"><a href="blank.html">java学习笔记</a></li>
							<li><a href="login.html">nginx学习笔记</a></li>
							<li><a href="lock_screen.html">分布式学习笔记</a></li>
						</ul></li>
 -->
      ...
      *********************************************************************************************************************************************************** -->
			...
			<section class="wrapper site-min-height">
				<div class="row mt">
					<!--
                        ...
                        -->
					<div
						style="height: 250px; margin-top: -25px; background: url(assets/img/instagram.jpg); background-size: 100%;"
						class="col-lg-12">
						<div style="text-align: center; margin-top: 120px;">
							<h3>
								<font color="white">我们的征途是星辰大海</font>
							</h3>
						</div>
					</div>
					<!--数据统计 -->
							...
							<div class="content-panel pn">
								...
								<div class="blog-text">
									<p>
										...
										typesetting industry. <a href="./myBlog.do?blog_id=1">Read
											More</a>
									</p>
								</div>
							</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="content-panel pn">
								...
								<div class="blog-text">
									<p>
										Lorem Ipsum is simply dummy text of the printing and
										typesetting industry. <a href="./myBlog.do?blog_id=2">Read
											More</a>
									</p>
								</div>
							</div>
						...
						<div class="col-lg-4 col-md-4 col-sm-4 mb">
							<div class="content-panel pn">
								...
								<div class="blog-text">
									<p>
										Lorem Ipsum is simply dummy text of the printing and
										typesetting industry. <a href="./myBlog.do?blog_id=3">Read
											More</a>
									</p>
								</div>
							</div>
		...
		<footer class="site-footer">
			<div class="text-center">
				2017 - Alvarez.is <a href="blank.html#" class="go-top"> <i
